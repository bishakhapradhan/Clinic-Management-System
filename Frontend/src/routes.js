...
//Patients
const AddPatient = React.lazy(()=> import ('./app/patients/AddPatient'))
const ViewPatient= React.lazy(()=> import ('./app/patients/ViewPatient'))
const EditPatient= React.lazy(()=> import ('./app/patients/EditPatient'))
...
const routes = [
  ...
  {path: '/patients', name :'View Patient', element: ViewPatient},
  {path: '/patients/add', name :'Add Patient', element: AddPatient},
  {path: '/patients/edit/:id', name :'Edit Patient', element: EditPatient}
